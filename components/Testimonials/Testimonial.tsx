        ...
        <Slider {...settings} className="w-full max-w-5xl">
          <div className="px-4">
            <TestimonialCard
              ...
              imageUrl="/images/Testimonials/YogeshLakhpatani.jpeg"
            />
          </div>
          <div className="px-4">
            <TestimonialCard
              ...
              imageUrl="/images/Testimonials/AmitGrover.jpg"
            />
          </div>
          <div className="px-4">
            <TestimonialCard
              ...
              imageUrl="/images/Testimonials/MansiDutta.jpeg"
            />
          </div>
          <div className="px-4">
            <TestimonialCard
              ...
              imageUrl="/images/Testimonials/SanjaySoni.jpeg"
            />
          </div>
        </Slider>
      </div>
